    ...
    >
      ...
      <div className="p-4 flex flex-col justify-between flex-1">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-[#eaeaec] mt-2">
          ...
          <button className="text-xs bg-[#f5f5f6] text-[#282c3f] font-bold px-3.5 py-1.5 rounded-xs border border-[#d4d5d9] group-hover:bg-[#ff3f6c] group-hover:text-white group-hover:border-[#ff3f6c] transition-all duration-200 uppercase tracking-wider">
            Visit Store
          </button>
        </div>
      </div>
